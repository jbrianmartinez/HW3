 ...
 *  @author Kevin Wayne
 */
public class FCPutsAndGets {

    // Do not instantiate.
    private FCPutsAndGets() { }
    ...
    public static void main(String[] args) {
        int distinct = 0, words = 0, numGets = 0, numWPuts = 0, numDPuts = 0;
        ...
        StdOut.println("numGets  = " + numGets);
        StdOut.println("numWPuts = " + numWPuts);
        StdOut.println("numDPuts = " + numDPuts);
    }
}
